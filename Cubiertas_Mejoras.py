...
def Cubiertas_Mejoras_Costa_Rica(usuario,puesto,perfil):
  ...
  # ----- Salir ---- #
    ...
    cursor01.execute(f"INSERT INTO registro (marca,usuario,nombre,perfil,puesto,supervisor,proceso,fecha_inicio,fecha_finalizacion,zona,bloques,cubiertas_y_mejoras_o_parcelas,horas)VALUES('{marca_11}','{usuario}','{nombre_11}','{perfil}','{puesto}','{supervisor_11}','Cubiertas y Mejoras','{fecha_inicio_11}','{fecha_finalizacion_11}','{zona_11}','{parcelas_11}','{cubiertas_11}','{horas_11}')")
    con.commit()
