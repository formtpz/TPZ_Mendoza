...
def Historial_Costa_Rica(usuario,puesto,perfil):
  ...
  if puesto=="Supervisor" or puesto=="Coordinador":    
    ...
    if personal_7=="Todos" and proceso_7_s=="Todos" and perfil_7_s=="Todos":
      ...
      data_1_r=pd.read_sql(f"select cast(id as integer),marca,usuario,nombre,perfil,puesto,supervisor,proceso,fecha_inicio,fecha_finalizacion,zona,cast(bloques_o_parcelas as integer),cast(parcelas_o_cubiertas_y_mejoras as integer),cast(horas as float) from registro where (fecha_inicio>='{fecha_referencia_1_7}' or fecha_inicio>='{fecha_referencia_2_7}') and (fecha_finalizacion<='{fecha_referencia_1_7}' or fecha_finalizacion<='{fecha_referencia_2_7}')", con)

    elif personal_7=="Todos" and proceso_7_s=="Todos" and perfil_7_s!="Todos":
        
      data_1_r=pd.read_sql(f"select cast(id as integer),marca,usuario,nombre,perfil,puesto,supervisor,proceso,fecha_inicio,fecha_finalizacion,zona,cast(bloques_o_parcelas as integer),cast(parcelas_o_cubiertas_y_mejoras as integer),cast(horas as float) from registro where (fecha_inicio>='{fecha_referencia_1_7}' or fecha_inicio>='{fecha_referencia_2_7}') and (fecha_finalizacion<='{fecha_referencia_1_7}' or fecha_finalizacion<='{fecha_referencia_2_7}') and perfil='{perfil_7_s}' ", con)

    elif personal_7=="Todos" and proceso_7_s !="Todos" and perfil_7_s=="Todos":
        
      data_1_r=pd.read_sql(f"select cast(id as integer),marca,usuario,nombre,perfil,puesto,supervisor,proceso,fecha_inicio,fecha_finalizacion,zona,cast(bloques_o_parcelas as integer),cast(parcelas_o_cubiertas_y_mejoras as integer),cast(horas as float) from registro where (fecha_inicio>='{fecha_referencia_1_7}' or fecha_inicio>='{fecha_referencia_2_7}') and (fecha_finalizacion<='{fecha_referencia_1_7}' or fecha_finalizacion<='{fecha_referencia_2_7}') and proceso='{proceso_7_s}' ", con)
  
    elif personal_7=="Todos" and proceso_7_s !="Todos" and perfil_7_s!="Todos":

      data_1_r=pd.read_sql(f"select cast(id as integer),marca,usuario,nombre,perfil,puesto,supervisor,proceso,fecha_inicio,fecha_finalizacion,zona,cast(bloques_o_parcelas as integer),cast(parcelas_o_cubiertas_y_mejoras as integer),cast(horas as float) from registro where (fecha_inicio>='{fecha_referencia_1_7}' or fecha_inicio>='{fecha_referencia_2_7}') and (fecha_finalizacion<='{fecha_referencia_1_7}' or fecha_finalizacion<='{fecha_referencia_2_7}') and proceso='{proceso_7_s}' and perfil='{perfil_7_s}' ", con)
  
    elif personal_7=="Operarios" and proceso_7_s =="Todos" and perfil_7_s=="Todos":

      data_1_r=pd.read_sql(f"select cast(id as integer),marca,usuario,nombre,perfil,puesto,supervisor,proceso,fecha_inicio,fecha_finalizacion,zona,cast(bloques_o_parcelas as integer),cast(parcelas_o_cubiertas_y_mejoras as integer),cast(horas as float) from registro where (fecha_inicio>='{fecha_referencia_1_7}' or fecha_inicio>='{fecha_referencia_2_7}') and (fecha_finalizacion<='{fecha_referencia_1_7}' or fecha_finalizacion<='{fecha_referencia_2_7}') and puesto='Operario Catastral'", con)
 
    elif personal_7=="Operarios" and proceso_7_s =="Todos" and perfil_7_s!="Todos":
        
      data_1_r=pd.read_sql(f"select cast(id as integer),marca,usuario,nombre,perfil,puesto,supervisor,proceso,fecha_inicio,fecha_finalizacion,zona,cast(bloques_o_parcelas as integer),cast(parcelas_o_cubiertas_y_mejoras as integer),cast(horas as float) from registro where (fecha_inicio>='{fecha_referencia_1_7}' or fecha_inicio>='{fecha_referencia_2_7}') and (fecha_finalizacion<='{fecha_referencia_1_7}' or fecha_finalizacion<='{fecha_referencia_2_7}') and puesto='Operario Catastral' and perfil='{perfil_7_s}' ", con)
 
    elif personal_7=="Operarios" and proceso_7_s !="Todos" and perfil_7_s=="Todos":
        
      data_1_r=pd.read_sql(f"select cast(id as integer),marca,usuario,nombre,perfil,puesto,supervisor,proceso,fecha_inicio,fecha_finalizacion,zona,cast(bloques_o_parcelas as integer),cast(parcelas_o_cubiertas_y_mejoras as integer),cast(horas as float) from registro where (fecha_inicio>='{fecha_referencia_1_7}' or fecha_inicio>='{fecha_referencia_2_7}') and (fecha_finalizacion<='{fecha_referencia_1_7}' or fecha_finalizacion<='{fecha_referencia_2_7}') and puesto='Operario Catastral' and proceso='{proceso_7_s}' ", con)
 
    elif personal_7=="Operarios" and proceso_7_s !="Todos" and perfil_7_s!="Todos":
        
      data_1_r=pd.read_sql(f"select cast(id as integer),marca,usuario,nombre,perfil,puesto,supervisor,proceso,fecha_inicio,fecha_finalizacion,zona,cast(bloques_o_parcelas as integer),cast(parcelas_o_cubiertas_y_mejoras as integer),cast(horas as float) from registro where (fecha_inicio>='{fecha_referencia_1_7}' or fecha_inicio>='{fecha_referencia_2_7}') and (fecha_finalizacion<='{fecha_referencia_1_7}' or fecha_finalizacion<='{fecha_referencia_2_7}') and puesto='Operario Catastral' and proceso='{proceso_7_s}' and perfil='{perfil_7_s}' ", con)

    elif personal_7=="Propio" and proceso_7_s=="Todos" and perfil_7_s=="Todos":
        
      data_1_r=pd.read_sql(f"select cast(id as integer),marca,usuario,nombre,perfil,puesto,supervisor,proceso,fecha_inicio,fecha_finalizacion,zona,cast(bloques_o_parcelas as integer),cast(parcelas_o_cubiertas_y_mejoras as integer),cast(horas as float) from registro where (fecha_inicio>='{fecha_referencia_1_7}' or fecha_inicio>='{fecha_referencia_2_7}') and (fecha_finalizacion<='{fecha_referencia_1_7}' or fecha_finalizacion<='{fecha_referencia_2_7}') and usuario='{usuario}'", con)

    elif personal_7=="Propio" and proceso_7_s=="Todos" and perfil_7_s!="Todos":
        
      data_1_r=pd.read_sql(f"select cast(id as integer),marca,usuario,nombre,perfil,puesto,supervisor,proceso,fecha_inicio,fecha_finalizacion,zona,cast(bloques_o_parcelas as integer),cast(parcelas_o_cubiertas_y_mejoras as integer),cast(horas as float) from registro where (fecha_inicio>='{fecha_referencia_1_7}' or fecha_inicio>='{fecha_referencia_2_7}') and (fecha_finalizacion<='{fecha_referencia_1_7}' or fecha_finalizacion<='{fecha_referencia_2_7}') and usuario='{usuario}' and perfil='{perfil_7_s}'", con)

    elif personal_7=="Propio" and proceso_7_s !="Todos" and perfil_7_s=="Todos":
        
      data_1_r=pd.read_sql(f"select cast(id as integer),marca,usuario,nombre,perfil,puesto,supervisor,proceso,fecha_inicio,fecha_finalizacion,zona,cast(bloques_o_parcelas as integer),cast(parcelas_o_cubiertas_y_mejoras as integer),cast(horas as float) from registro where (fecha_inicio>='{fecha_referencia_1_7}' or fecha_inicio>='{fecha_referencia_2_7}') and (fecha_finalizacion<='{fecha_referencia_1_7}' or fecha_finalizacion<='{fecha_referencia_2_7}') and usuario='{usuario}' and proceso='{proceso_7_s}'", con)

    elif personal_7=="Propio" and proceso_7_s !="Todos" and perfil_7_s!="Todos":
        
      data_1_r=pd.read_sql(f"select cast(id as integer),marca,usuario,nombre,perfil,puesto,supervisor,proceso,fecha_inicio,fecha_finalizacion,zona,cast(bloques_o_parcelas as integer),cast(parcelas_o_cubiertas_y_mejoras as integer),cast(horas as float) from registro where (fecha_inicio>='{fecha_referencia_1_7}' or fecha_inicio>='{fecha_referencia_2_7}') and (fecha_finalizacion<='{fecha_referencia_1_7}' or fecha_finalizacion<='{fecha_referencia_2_7}') and proceso='{proceso_7_s}' perfil='{perfil_7_s}'", con)

    elif personal_7=="Personal Asignado" and proceso_7_s =="Todos" and perfil_7_s=="Todos":
        
      data_1_r=pd.read_sql(f"select cast(id as integer),marca,usuario,nombre,perfil,puesto,supervisor,proceso,fecha_inicio,fecha_finalizacion,zona,cast(bloques_o_parcelas as integer),cast(parcelas_o_cubiertas_y_mejoras as integer),cast(horas as float) from registro where (fecha_inicio>='{fecha_referencia_1_7}' or fecha_inicio>='{fecha_referencia_2_7}') and (fecha_finalizacion<='{fecha_referencia_1_7}' or fecha_finalizacion<='{fecha_referencia_2_7}') and supervisor='{nombre_7}'", con)

    elif personal_7=="Personal Asignado" and proceso_7_s =="Todos" and perfil_7_s!="Todos":

      data_1_r=pd.read_sql(f"select cast(id as integer),marca,usuario,nombre,perfil,puesto,supervisor,proceso,fecha_inicio,fecha_finalizacion,zona,cast(bloques_o_parcelas as integer),cast(parcelas_o_cubiertas_y_mejoras as integer),cast(horas as float) from registro where (fecha_inicio>='{fecha_referencia_1_7}' or fecha_inicio>='{fecha_referencia_2_7}') and (fecha_finalizacion<='{fecha_referencia_1_7}' or fecha_finalizacion<='{fecha_referencia_2_7}') and supervisor='{nombre_7}' and perfil='{perfil_7_s}'", con)

    elif personal_7=="Personal Asignado" and proceso_7_s !="Todos" and perfil_7_s=="Todos":
      
      data_1_r=pd.read_sql(f"select cast(id as integer),marca,usuario,nombre,perfil,puesto,supervisor,proceso,fecha_inicio,fecha_finalizacion,zona,cast(bloques_o_parcelas as integer),cast(parcelas_o_cubiertas_y_mejoras as integer),cast(horas as float) from registro where (fecha_inicio>='{fecha_referencia_1_7}' or fecha_inicio>='{fecha_referencia_2_7}') and (fecha_finalizacion<='{fecha_referencia_1_7}' or fecha_finalizacion<='{fecha_referencia_2_7}') and supervisor='{nombre_7}' and proceso='{proceso_7_s}'", con)
      
    elif personal_7=="Personal Asignado" and proceso_7_s !="Todos" and perfil_7_s!="Todos":

      data_1_r=pd.read_sql(f"select cast(id as integer),marca,usuario,nombre,perfil,puesto,supervisor,proceso,fecha_inicio,fecha_finalizacion,zona,cast(bloques_o_parcelas as integer),cast(parcelas_o_cubiertas_y_mejoras as integer),cast(horas as float) from registro where (fecha_inicio>='{fecha_referencia_1_7}' or fecha_inicio>='{fecha_referencia_2_7}') and (fecha_finalizacion<='{fecha_referencia_1_7}' or fecha_finalizacion<='{fecha_referencia_2_7}') and supervisor='{nombre_7}' and proceso='{proceso_7_s}' and perfil='{perfil_7_s}'", con)
    ...
    data_2_r = data_1_r.groupby(["nombre", "fecha_finalizacion","proceso"], as_index=False)[["bloques_o_parcelas","parcelas_o_cubiertas_y_mejoras","horas"]].agg(np.sum)
  ...
  # ----- Operario Catastral ---- #
    ...
    if proceso_7_o =="Todos":
      ...
      data_1_r=pd.read_sql(f"select cast(id as integer),marca,usuario,nombre,perfil,puesto,supervisor,proceso,fecha_inicio,fecha_finalizacion,zona,cast(bloques_o_parcelas as integer),cast(parcelas_o_cubiertas_y_mejoras as integer),cast(horas as float) from registro where  (fecha_inicio>='{fecha_referencia_1_7}' or fecha_inicio>='{fecha_referencia_2_7}') and (fecha_finalizacion<='{fecha_referencia_1_7}' or fecha_finalizacion<='{fecha_referencia_2_7}') and usuario='{usuario}' and proceso='{proceso_7_o}'", con)
