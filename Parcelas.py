...
def Parcelas_Costa_Rica(usuario,puesto,perfil):
  ...
  # ----- Salir ---- #
    ...
    cursor01.execute(f"INSERT INTO registro (marca,usuario,nombre,perfil,puesto,supervisor,proceso,fecha_inicio,fecha_finalizacion,zona,bloques,cubiertas_y_mejoras_o_parcelas,horas)VALUES('{marca_10}','{usuario}','{nombre_10}','{perfil}','{puesto}','{supervisor_10}','Parcelas','{fecha_inicio_10}','{fecha_finalizacion_10}','{zona_10}','{bloques_10}','{parcelas_10}','{horas_10}')")
    con.commit()
